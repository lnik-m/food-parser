  ...
  const data = [
    {
      ...
      imgLink:
        'https://cdn.dodostatic.net/static/Img/Products/bce16b1b340f445297fd20ba21df29f2_584x584.png'
    },
    {
      name: 'Мясная',
      description:
      ...
      imgLink:
        'https://cdn.dodostatic.net/static/Img/Products/5f11f129fd7448ef90d3057730f739d9_584x584.png'
    },
    {
      ...
      link: '',
      imgLink:
        'https://www.hachapuriivino.ru/image/cache/catalog/%20%D0%BE%D0%BA%D1%82%D1%8F%D0%B1%D1%80%D1%8C/IMG_6139-300x300.jpg'
    },
    {
      name: 'ХАЧАПУРИ С СЫРОМ ДОРБЛЮ И ГРУШЕЙ',
      description:
        'ХАЧАПУРИ С СЫРОМ ДОРБЛЮ, СЫРОМ СУЛУГУНИ, КОНСЕРВИРОВАННОЙ ГРУШЕЙ И РОСТКАМИ ПОДСОЛНУХА.',
      price: 490,
      site: {
        name: 'Бахрома',
    ...
    },
    {
      ...
      description:
        'СЫРНЫШЕ ШАРИКИ ИЗ СЫРА СУЛУГУНИ, ОБЖАРЕННЫЕ В СУХАРЯХ ПАНКО. ПОДАЮТСЯ С ЯГОДНЫМ СОУСОМ.',
      price: 330,
      site: {
        name: 'Бахрома',
        link: 'https://www.bahroma1.ru/'
